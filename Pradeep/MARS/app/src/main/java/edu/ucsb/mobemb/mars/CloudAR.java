...
import edu.ucsb.mobemb.mars.SampleAppMenu.SampleAppMenu;
import edu.ucsb.mobemb.mars.SampleAppMenu.SampleAppMenuGroup;
import edu.ucsb.mobemb.mars.SampleAppMenu.SampleAppMenuInterface;
import edu.ucsb.mobemb.mars.SampleApplication.SampleApplicationControl;
import edu.ucsb.mobemb.mars.SampleApplication.SampleApplicationException;
import edu.ucsb.mobemb.mars.SampleApplication.SampleApplicationSession;
import edu.ucsb.mobemb.mars.SampleApplication.utils.LoadingDialogHandler;
import edu.ucsb.mobemb.mars.SampleApplication.utils.SampleApplicationGLView;
import edu.ucsb.mobemb.mars.SampleApplication.utils.Teapot;
import edu.ucsb.mobemb.mars.SampleApplication.utils.Texture;


public class CloudAR extends Activity implements SampleApplicationControl,
        SampleAppMenuInterface
{
    private static final String LOGTAG = "MARS::CloudReco";
    ...
    // Our renderer:
    private CloudARRenderer mRenderer;
    ...
    private void initApplicationAR()
    {
        ...
        mRenderer = new CloudARRenderer(vuforiaAppSession, this);
        Log.d("GP","initApplicationAR setTextures ="+mTextures.elementAt(0).mTextureID+" size = "+mTextures.capacity());
    ...
    public void showErrorMessage(int errorCode, double errorTime, boolean finishActivityOnError)
    {
        ...
        runOnUiThread(new Runnable()
        {
            public void run()
            {
                ...
                builder
                        .setMessage(
                                getStatusDescString(CloudAR.this.mlastErrorCode))
                        .setTitle(
                                getStatusTitleString(CloudAR.this.mlastErrorCode))
                        .setCancelable(false)
                        .setIcon(0)
