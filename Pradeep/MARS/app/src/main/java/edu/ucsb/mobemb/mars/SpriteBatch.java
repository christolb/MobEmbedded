...
/**
 * Created by christolmb on 2/24/2015.
 */

import edu.ucsb.mobemb.mars.programs.Program;
...
public class SpriteBatch {
    ...
    public void endBatch()  {
        Log.d("Sprite", "I'm here doing the draw with numSprite=" + numSprites);
    ...
    public void drawSprite(float x, float y, float width, float height, TextureRegion region, float[] modelMatrix)  {
        Log.d("Sprite", "numSprite= "+ numSprites + "maxSprite= " + maxSprites);
